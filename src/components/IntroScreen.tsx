...
const IntroScreen: React.FC<IntroScreenProps> = ({ onComplete }) => {
  ...
  const { playWhisper, playBoom, playSwoosh } = useSound();
    ...
    if (isHolding && holdProgress < 1) {
      interval = setInterval(() => {
        setHoldProgress(prev => {
          ...
          // Play whisper sounds at intervals
  ...
  }, [isHolding, holdProgress, playWhisper]);
  ...
  }, [showTransition, playBoom, playSwoosh, onComplete]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-indigo-900 to-black flex flex-col items-center justify-center relative overflow-hidden">
